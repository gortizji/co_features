...
from data.injection import create_linf_carrier, inject_perp_feature
...
@hydra.main(config_path="config/injected_perp_feature_cifar_fgsm_train", config_name="config")
def main(cfg: DictConfig) -> None:
    ...
    train_loader = inject_perp_feature(
        trainset,
        cfg.beta / 255,
        V=V,
    ...
    test_loader = inject_perp_feature(
        testset,
        cfg.beta / 255,
        V=V,
