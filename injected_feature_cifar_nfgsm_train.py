...
from attacks import NFGSM, RestartPGD, evaluate_attack
...
@hydra.main(config_path="config/injected_feature_cifar_nfgsm_train", config_name="config")
def main(cfg: DictConfig) -> None:
    ...
    attack = NFGSM(epsilon, alpha, unif=cfg.unif, clip_box=cfg.clip_box)
